...
from utils.trainer import trainer_heart
...
if __name__ == "__main__":
    ...
    args.num_classes = 2
    args.x_dir = config.inp_dir
    args.y_dir = config.lab_dir
    args.tr_csv = config.tr_csv
    args.tt_csv = config.tt_csv
    args.batch_size = config.batch_size
    args.model_weight_pth = config.model_weight_pth
    ...
    # net.load_state_dict(torch.load(args.model_weight_pth))

    trainer = {'Heart': trainer_heart, }
